...
anova_result <- aov(data = imputed_new, TARGET_deathRate ~ povertyPercent + PctBlack + PctNoHS18_24 + PctHS18_24 + isSoutheast)
...
```{r}
mod2 <- lm(data = imputed_new, TARGET_deathRate ~ povertyPercent + PctBlack + PctHS18_24 + isSoutheast)
summary(mod2)
```
...
x = data.matrix(imputed_new[, c('povertyPercent', 'PctBlack', 'PctHS18_24', 'isSoutheast','PctPublicCoverage','PctPublicCoverageAlone')])
